...
//    NSLog(@"time:%@  ",_lastUpdateTime);
    ...
    if ([cmp1 day] == [cmp2 day]) { // 今天
        formatter.dateFormat = [NSString stringWithFormat:@"HH:mm"];//,[TioBonHelper coreDataLanguageString:@"APP000099"]];//@"今天 HH:mm";
...
//    NSLog(@"time:%@  -- formatter:%@",time,formatter.dateFormat);
    // 3.显示日期
