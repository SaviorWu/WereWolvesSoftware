...
//         3.状态标签
        ...
        // 4.箭头图片
        UIImageView *arrowImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"fresh.png"]];//kSrcName(@"arrow.png")]];
...
//    _lastUpdateTimeLabel.frame = CGRectMake(statusX, lastUpdateY, statusWidth, statusHeight);
    ...
    // 3.箭头
//    CGFloat arrowX = 20;
//    _arrowImage.center = CGPointMake(w / 2, h * 0.5);
    
    // 1.状态标签
    _statusLabel.frame = CGRectMake(statusX, lastUpdateY, statusWidth, statusHeight);//CGRectMake(30, (h - statusHeight) / 2 + 25, [[UIScreen mainScreen] bounds].size.width - 60, statusHeight);
...
{    
    ...
    if (_scrollView.isDragging) {
        ...
        [UIView animateWithDuration:0.1 animations:^{
            _arrowImage.transform = CGAffineTransformMakeRotation(degreeToRadians(offsetY * 2));
...
- (void)starRotation
{
    ...
    [_arrowImage.layer addAnimation:rotationAnimation forKey:@"fresh"];
}
...
- (void)stopRotation
{
    [_arrowImage.layer removeAnimationForKey:@"fresh"];
}
